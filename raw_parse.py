...
path_base = f'//pzpwcmfs01/ca/11_Transmission Analysis/ERCOT/06 - CRR/Monthly/{year}/{year}-{month_numeric}/Network Model/'
output_root = f'//pzpwcmfs01/ca/11_Transmission Analysis/ERCOT/06 - CRR/Monthly/{year}/{year}-{month_numeric}/Network Model/'
aggregate_path = f'//pzpwcmfs01/ca/11_Transmission Analysis/ERCOT/06 - CRR/Monthly/{year}/{year}-{month_numeric}/Network Model/ALL_YEARS_LOAD_DATA.csv'
